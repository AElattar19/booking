        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">الادارة</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="chart-morris.html">الادارة</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="products.html">الاعلانات</a></li>
                </ul>
            </li>
