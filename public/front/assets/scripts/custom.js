(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.show-more-button2').on('click', function (e) {
            e.preventDefault();
            $(this).toggleClass('active');
            $('.show-more2').toggleClass('visible');
            if ($('.show-more2').is(".visible")) {
                var el = $('.show-more2'),
                        curHeight = el.height(),
                        autoHeight = el.css('height', 'auto').height();
                el.height(curHeight).animate({
...
$('.more-amentities').click(function () {
    $('.hidden-features').show();
    $('.unhidden-features').hide();
    $('.more-amentities').hide();
});
...
$("#close_announcment").click(function () {
    $(".announcment").hide('slow');
    setCookie('announcment', 'shown', '1');
}); 